...
export const projects: Project[] = [
  {
    ...
    image: 'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/d3fe85108953861.5fc8e28a67a92.jpg',
  ...
  },
  {
    ...
    image: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/fb5e39146336587.62aecc632c13c.png',
  ...
  },
  {
    ...
    image: 'https://tinyurl.com/4nt7udjy',
    liveUrl: 'https://curious-coder-creations.lovable.app/',
    githubUrl: 'https://github.com/Aswinprasath/momentum-portfolio',
    features: ['Dark/Light Mode', 'Smooth Animations', 'Responsive Design', 'SEO Optimized', 'Fast Loading', 'Contact Form'],
    technologies: ['React', 'TypeScript', 'Tailwind CSS', 'Vite', 'React Router','AI'],
    duration: '2 Days',
